...
<head>
    ...
    <title>Evoting | Data Calon</title>
</head>
<body>
  ...
  <div class="dashboard-section">
    ...
    <table>
      ...
      <?php
        ...
        <tr>
            <td><?= $counter++; ?></td>
            <td><?= $row['nama_calon_ketua']; ?></td>
            <td><?= $row['nama_calon_wakil_ketua']; ?></td>
            <td>
              <img src="<?= $row['gambar']; ?>" alt="" height="150" width="150">
            </td>
            <td>
                <div class="aksi">
                    <form action="datacalon/edit" method="post">
                    <input type="hidden" name="id" value="<?php echo $row['id_calon']; ?>">
                        <button class="edit">Edit</button>
                    </form>
                    <form action="datacalon/delete" method="post">
                        <input type="hidden" name="id" value="<?php echo $row['id_calon']; ?>">
                        <input type="hidden" name="foto" value="<?php echo $row['gambar']; ?>">
