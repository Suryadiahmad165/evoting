...
<head>
    ...
    <title>Evoting | Tambah Calon</title>
</head>
<body>
...
<div id="main-content" class="ml-64 p-4">
    ...
    <form action="tambahcalon/store" method="post" enctype="multipart/form-data">
        <label for="nimketua">
            Nomor Induk Mahasiswa Calon Ketua
            <input type="text" placeholder="NIM" id="nimketua" name="nimketua" required>
        </label>
        <label for="nimwakil">
            Nomor Induk Mahasiswa Calon Wakil Ketua
            <input type="text" placeholder="NIM" id="nimwakil" name="nimwakil" required>
        </label>
        <label for="namaketua">
            Nama Calon Ketua
            <input type="text" placeholder="Nama Calon Ketua" id="namaketua" name="namaketua" required>
        </label>
        <label for="namawakil">
            Nama Calon Wakil Ketua
            <input type="text" placeholder="Nama Calon Wakil Ketua" id="namawakil" name="namawakil" required>
        </label>
        <label for="visi">
            Visi
            <input type="text" name="visi" id="visi" placeholder="Visi" required>
        </label>
        <label for="misi">
            Misi
...
<script src="../public/js/calonValidationMessage.js"></script>
<script>
        <?php 
            SweetAlert::Alert();
        ?>
